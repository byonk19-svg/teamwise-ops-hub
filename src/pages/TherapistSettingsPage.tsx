        ...
        <div className="grid gap-6 max-w-4xl">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Your position in the department</p>
                </div>
                <Badge variant="secondary">Staff Therapist</Badge>
              </div>
              <Separator />
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm">View Own Schedule</span>
                  <Badge variant="outline" className="bg-success/10 text-success border-success">Enabled</Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm">Submit Availability</span>
                  <Badge variant="outline" className="bg-success/10 text-success border-success">Enabled</Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm">Request Shift Swaps</span>
                  <Badge variant="outline" className="bg-success/10 text-success border-success">Enabled</Badge>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium">Swap Alerts</p>
                  <p className="text-sm text-muted-foreground">Notifications when swap requests are approved/denied</p>
                </div>
                <Switch
                  checked={swapAlerts}
                  onCheckedChange={setSwapAlerts}
                />
              </div>
            </CardContent>
          </Card>
